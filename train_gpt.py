...
def main():
    ...
    for step in range(train_steps + 1):
        ...
        print0(f"step:{step+1}/{train_steps}, train_time:{approx_training_time_ms/1000:.1f}ms, step_avg:{approx_training_time_ms/(step + 1):.2f}ms, train loss:{train_loss:.2f},  lr:{training_schedule.get_lr(step):.2f}", console=True)
